...
static Key keys[] = {
	...
	{0,			   XF86XK_MonBrightnessUp, spawn,  CMD("st -e  brightnessctl -d  intel_backlight set +10% ") },
	{0,                        XF86XK_MonBrightnessDown, spawn,  CMD("st -e  brightnessctl -d  intel_backlight set 10%-") },
	...
	{ MODKEY|Mod1Mask,        XK_g,    spawn,          CMD("google-chrome-stable") },
	{ MODKEY|Mod1Mask,	  XK_d,    spawn,	   CMD("navicat15-premium-en-patched.AppImage")},
	{ MODKEY|Mod1Mask,        XK_n,    spawn,          CMD("netbeans") },
	{ MODKEY|Mod1Mask,        XK_r,    spawn,          CMD("st -e rtv") },
	{ MODKEY|Mod1Mask, 	  XK_v,	   spawn,	   CMD("code")},
	{ MODKEY|Mod1Mask,	  XK_l,	   spawn,	   CMD("slock")},	
